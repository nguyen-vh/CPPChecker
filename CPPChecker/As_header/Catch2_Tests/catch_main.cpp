...
#include "../cppchecker_fulloutput.hpp"
#include "catch.hpp"
...
M_CLASS_AND_MEMBER_2(MyClassY, check_int_printed_f_t, "int printed()",
                     check_int_IDE_t, "int IDE")
M_CLASS_AND_MEMBER_2(MyClassYA, check_int_printed_f_t, "int printed()",
                     check_int_IDE_t, "int IDE")

M_CLASS_AND_MEMBER_3(MyClassZ, check_OHM_f, "OHM()", check_double_AMP_t,
                     "double AMP", check_float_VOLT_t, "float VOLT")
M_CLASS_AND_MEMBER_3(MyClassZA, check_OHM_f, "OHM()", check_double_AMP_t,
                     "double AMP", check_float_VOLT_t, "float VOLT")
