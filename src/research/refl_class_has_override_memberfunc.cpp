...
auto main(int /*argc*/, char* /*argv*/[]) -> int {
  std::cout << class_has_override_memberfunc<"X"_ls, "foo"_ls> << std::endl;
  std::cout
      << class_has_override_memberfunc<"X"_ls, "foo"_ls, void> << std::endl;
  std::cout << class_has_override_memberfunc<"X"_ls, "foo"_ls, void,
                                             int> << std::endl;

  std::cout << std::endl;

  std::cout << class_has_override_memberfunc<"X"_ls, "goo"_ls> << std::endl;
  std::cout
      << class_has_override_memberfunc<"X"_ls, "goo"_ls, void> << std::endl;
  std::cout << class_has_override_memberfunc<"X"_ls, "goo"_ls, void,
                                             int> << std::endl;

  std::cout << std::endl;

  std::cout << class_has_override_memberfunc<"X"_ls, "boo"_ls> << std::endl;
  std::cout
      << class_has_override_memberfunc<"X"_ls, "boo"_ls, void> << std::endl;
  std::cout << class_has_override_memberfunc<"X"_ls, "boo"_ls, void,
                                             int> << std::endl;
