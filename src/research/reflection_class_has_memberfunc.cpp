...
auto main(int /*argc*/, char* /*argv*/[]) -> int {
  std::cout << class_has_memberfunc<"XY"_ls, "foos"_ls> << std::endl;
  std::cout << class_has_memberfunc<"X"_ls, "foos"_ls, double> << std::endl;
  std::cout << class_has_memberfunc<"X"_ls, "foo"_ls> << std::endl;
  std::cout << class_has_memberfunc<"X"_ls, "foo"_ls, double*> << std::endl;
  std::cout
      << class_has_memberfunc<"X"_ls, "foo"_ls, double, double> << std::endl;
  std::cout << class_has_memberfunc<"XY"_ls, "foo"_ls, double,
                                    std::string> << std::endl;

  std::cout << class_has_memberfunc<"X"_ls, "foo"_ls, double,
                                    std::string> << std::endl;
  std::cout << class_has_memberfunc<"X"_ls, "foo"_ls, double, int,
                                    std::string> << std::endl;
