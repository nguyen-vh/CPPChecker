...
auto main(int /*argc*/, char* /*argv*/[]) -> int {
  ...
  std::cout << has_free_function<"test::goo"_ls, float> << std::endl;
  std::cout << has_free_function<"test::goo"_ls, float, int> << std::endl;

  std::cout << std::endl;

  std::cout << has_free_function<"test::goo"_ls, int> << std::endl;
  std::cout << has_free_function<"test::goo"_ls, float, float> << std::endl;
