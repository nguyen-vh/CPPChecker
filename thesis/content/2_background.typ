...
The capacity of a programming language to serve as its own metalanguage enables the practice of reflective programming, a concept referred to as #box["reflection" @wiki2026metaprogramming]. #box[#cite(<onyekwere2023medium>, form: "author")] asserts that "reflection is a mechanism that enables a process to perform introspective operations, examine, and modify its own structure and behavior" @onyekwere2023medium @wiki2026reflection. Two forms of reflection are distinguished. The first of these is known as runtime reflection, and it is present in languages such as Golang and Java. The second type, compile-time reflection, is supported by the #box[C++] programming language as well as Rust, among other programming languages.
