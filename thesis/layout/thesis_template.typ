...
#import "/layout/abbreviations.typ": *
...
#let thesis(
  ...
  show heading.where(level: 1): it => {
    ...
    if it.numbering != none and it.func() == heading {
      text(weight: 700, size: 1.8em)[#counter(heading).display("1") #it.body]
    } else {
      text(weight: 700, size: 1.8em)[#it.body]
    }
  }
  body
